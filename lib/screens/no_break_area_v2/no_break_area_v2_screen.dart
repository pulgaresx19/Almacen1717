...
import 'no_break_area_v2_panel.dart';

class NoBreakAreaV2Screen extends StatefulWidget {
  final bool isActive;
  const NoBreakAreaV2Screen({super.key, this.isActive = false});

  @override
  State<NoBreakAreaV2Screen> createState() => _NoBreakAreaV2ScreenState();
}

class _NoBreakAreaV2ScreenState extends State<NoBreakAreaV2Screen> {
              ...
              children: [
                ...
                Expanded(
                  child: Container(
                    ...
                    child: NoBreakAreaV2Panel(searchQuery: _searchController.text.trim()),
                  ),
                ),
              ],
            ),
