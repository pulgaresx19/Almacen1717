...
import '../main.dart'
    show appLanguage, isDarkMode, isSidebarExpandedNotifier, currentUserData;
...
class _DriverModuleState extends State<DriverModule> {
      ...
      if (uUser != null) {
        ...
        if (userRow != null && userRow['master-driver'] != null) {
          if (mounted) {
            setState(
              () => _isMasterDriver =
                  userRow['master-driver'] == true ||
                  userRow['master-driver'].toString().toLowerCase() == 'true',
            );
          }
        } else {
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder<bool>(
      ...
      builder: (context, dark, child) {
        ...
        final Color bgCard = dark
            ? Colors.white.withAlpha(10)
            : const Color(0xFFffffff);
        final Color borderCard = dark
                        ...
                        builder: (context, snapshot) {
                            ...
                            return Center(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: 16),
                                  Text(
                                    'Connection lost or failed to load data.\nRetrying...',
                          ...
                          var delivers =
                              List<Map<String, dynamic>>.from(
                                ...
                                if (currentNoShow != null &&
                                    currentNoShow is List) {
                                  final currentUserFullName =
                                      currentUserData.value?['full-name'] ??
                                      'Unknown';
                                  bool hasNoShowed = currentNoShow.any(
                                    (ns) =>
                                        ns is Map &&
                                        ns['user'] == currentUserFullName,
                                  );
                          ...
                          delivers.sort((a, b) {
                            ...
                            final statusA =
                                a['status']?.toString() ?? 'Waiting';
                            final statusB =
                                b['status']?.toString() ?? 'Waiting';

                            int indexA = statusOrder.indexWhere(
                              (element) =>
                                  element.toLowerCase() ==
                                  statusA.toLowerCase(),
                            );
                            int indexB = statusOrder.indexWhere(
                              (element) =>
                                  element.toLowerCase() ==
                                  statusB.toLowerCase(),
                            );
                            ...
                            final da =
                                DateTime.tryParse(taStr) ?? DateTime(1970);
                            final db =
                                DateTime.tryParse(tbStr) ?? DateTime(1970);
                            ...
                            return Center(
                              child: SingleChildScrollView(
                                child: Padding(
                                  ...
                                  child: _buildDriverVerificationCard(
                                    delivers.first,
                                    dark,
                                  ),
                                ),
                          ...
                          return ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              if (u['time-deliver'] != null) {
                                final tdt = DateTime.tryParse(
                                  u['time-deliver'].toString(),
                                )?.toLocal();
                                if (tdt != null) {
                                  timeStr = DateFormat('hh:mm a').format(tdt);
                                }
                              }
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    color: dark
                        ...
                        : const Color(0xFFf3f4f6), // Solid, opaque background
                    alignment: Alignment.center,
                    child: GestureDetector(
                      onTap:
                          ...
                          child: Column(
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  border: Border(
                                    bottom: BorderSide(color: borderCard),
                                  ),
                                ),
                                child: Row(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                ...
                                child: Padding(
                                  ...
                                  child:
                                      StreamBuilder<List<Map<String, dynamic>>>(
                                        ...
                                        builder: (context, snapshot) {
                                          if (!snapshot.hasData) {
                                            return _buildDriverActivityPanel(
                                              _selectedDriver!,
                                              dark,
                                              textP,
                                              textS,
              ...
              Positioned.fill(
                child: GestureDetector(
                  ...
                  child: Container(
                    color: dark
                        ? const Color(0xFF0f172a)
                        : const Color(0xFFf3f4f6), // Solid colored background
                    alignment: Alignment.center,
                    child: GestureDetector(
  ...
  Widget _buildDriverVerificationCard(
                  ...
                  Padding(
                    ...
                    child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: dark
                              ? const Color(0xFFca8a04).withAlpha(40)
                              : const Color(0xFFfef08a).withAlpha(150),
                          shape: BoxShape.circle,
                        ),
                        child: Icon(
                          Icons.info_outline_rounded,
            ...
            child: Column(
              children: [
                  ...
                  children: [
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  u['truck-company']?.toString() ?? 'COMPAÑÍA',
                                  style: TextStyle(
                                    color: dark
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                Text(
                                  u['door']?.toString().isNotEmpty == true
                                      ? u['door'].toString()
                                      : '-',
                                  style: TextStyle(
                                    color: dark
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color:
                              (u['status']?.toString().toLowerCase().contains(
                                    'pending',
                                  ) ==
                                  true)
                              ? (dark
                ...
                Row(
                  children: [
                    Expanded(
                      child: _confirmDetailRow(
                        Icons.local_shipping_rounded,
                        appLanguage.value == 'es' ? 'Tipo' : 'Type',
                        u['type']?.toString().isNotEmpty == true
                            ? u['type'].toString()
                            : '-',
                        dark,
                      ),
                    ...
                    Expanded(
                      child: _confirmDetailRow(
                        ...
                        'ID Pickup',
                        u['id-pickup']?.toString().isNotEmpty == true
                            ? u['id-pickup'].toString()
                            : '-',
                        dark,
                      ),
                    ),
                ...
                Row(
                  children: [
                    Expanded(
                      child: _confirmDetailRow(
                        Icons.access_time_rounded,
                        appLanguage.value == 'es' ? 'Hora' : 'Time',
                        timeStr,
                        dark,
                      ),
                    ),
                ...
                if (u['remarks']?.toString().isNotEmpty == true) ...[
                  ...
                  _confirmDetailRow(
                    Icons.notes_rounded,
                    appLanguage.value == 'es' ? 'Comentarios' : 'Remarks',
                    u['remarks'].toString(),
                    dark,
                  ),
                ],
              ...
              children: [
                TextButton.icon(
                  ...
                  onPressed: () async {
                    ...
                    final currentUserFullName =
                        currentUserData.value?['full-name'] ?? 'Unknown';
                    ...
                    try {
                      ...
                      } else if (currentNoShow is Map &&
                          currentNoShow.isNotEmpty) {
                ...
                ElevatedButton.icon(
                  onPressed: () async {
                    ...
                    final currentUserAvatar =
                        currentUserData.value?['avatar-url'];
                  ...
                  label: Text(
                    appLanguage.value == 'es' ? 'Confirmar' : 'Confirm',
                    style: const TextStyle(
                      fontWeight: FontWeight.bold,
                      letterSpacing: 0.5,
                    ),
  ...
  void _showPendingRejectionDialog(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        labelText: appLanguage.value == 'es'
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () async {
                            ...
                            if (u['report-pending'] is List) {
                              existingReports = List<dynamic>.from(
                                u['report-pending'],
                              );
                            ...
                            try {
                              ...
                              debugPrint(
                                'Error updating pending status: $error',
                              );
                            }
                ...
                if (_isLoadingAwbs)
                  ...
                  Padding(
                    ...
                    child: Center(
                      child: Text(
                        appLanguage.value == 'es'
                            ? 'No hay AWBs registrados para este chófer.'
                            : 'No AWBs attached to this driver.',
                  ...
                  ..._driverAwbs.asMap().entries.map((entry) {
                    ...
                    final isUld = awb['ULD-number'] != null;
                    final awbNum = isUld
                        ? awb['ULD-number']!.toString()
                        : (awb['AWB-number']?.toString() ?? '-');
                    ...
                    for (var item in listPickup) {
                      if (item is Map &&
                          ((item['AWB-number'] == awbNum) ||
                              (item['ULD-number'] == awbNum))) {
                        piecesStr = item['pieces']?.toString() ?? '';
                        weightStr = item['weight']?.toString() ?? '';
                        remarkStr = item['remarks']?.toString() ?? '';
                        if (!piecesStr.toLowerCase().contains('pcs') &&
                            piecesStr.isNotEmpty) {
                          piecesStr += ' Pcs';
                        }
                                ...
                                children: [
                                  ...
                                  Text(
                                    appLanguage.value == 'es'
                                        ...
                                        : 'The delivery has been successfully recorded.',
                                    style: TextStyle(
                                      color: dark
                                          ? const Color(0xFF94a3b8)
                                          : const Color(0xFF64748b),
  ...
  List<Widget> _buildSavedDeliveryUI(
    Map? matchingDelivery,
    String awbNum,
    bool dark,
    Color textP,
    Color textS,
    ...
    if (matchingDelivery == null || matchingDelivery['references'] == null) {
      return [];
    }
    List refs = matchingDelivery['references'] is List
        ? matchingDelivery['references']
        : [];
    if (refs.isEmpty) {
      return [
        Padding(
    ...
    return grouped.entries.map((entry) {
      ...
      String rawDate = items.isNotEmpty
          ? (items.first['refDate']?.toString() ?? '')
          : '';
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: isHidden
                    ? null
                    : Border(bottom: BorderSide(color: borderCard)),
              ),
              child: Row(
                children: [
                  Expanded(
                ...
                child: LayoutBuilder(
                  builder: (context, constraints) {
                    List<DataRow> tableRows = items.map((item) {
                      ...
                      if (displayName == 'NO BREAK AREA' ||
                          displayName == 'NO_BREAK') {
  ...
  Widget _buildAwbDetailPanel(
    ...
    final bool isUld = awb['ULD-number'] != null;
    final awbNum = isUld
        ? awb['ULD-number']!.toString()
        : (awb['AWB-number']?.toString() ?? '-');
        ...
        for (var d in (awb['data-deliver'] as List)) {
          ...
          if (d is Map && d['references'] is List) {
            for (var ref in d['references']) {
              if (ref is Map) {
                alreadyPickedUpKeys.add(
                  '${ref['refULD']}_${ref['refNumber']}_${ref['item']}',
                );
              }
            }
          }
    ...
    if (isUld) {
      awbItems = [
        {
          'refULD': awbNum,
          'refCarrier': awb['refCarrier']?.toString() ?? '',
          'refNumber': awb['refNumber']?.toString() ?? '',
          'refDate': awb['refDate']?.toString() ?? '',
          'pieces': awb['pieces']?.toString() ?? '0',
          'status': awb['status']?.toString() ?? 'Waiting',
        }
      ];
    } else if (awb['data-AWB'] is List) {
    ...
    if (awb['data-location'] is List) {
      locList = awb['data-location'];
        ...
        (awb['data-location'] as Map).isNotEmpty) {
      locList = [awb['data-location']];
    }
    ...
    if (awb['data-coordinator'] is List) {
      coordList = awb['data-coordinator'];
        ...
        (awb['data-coordinator'] as Map).isNotEmpty) {
      coordList = [awb['data-coordinator']];
    }
    ...
    if (_selectedDriver != null && _selectedDriver!['list-pickup'] != null) {
      ...
      for (var item in listPickup) {
        if (item is Map &&
          ...
          if (!deliverPiecesStr.toLowerCase().contains('pcs') &&
              deliverPiecesStr.isNotEmpty) {
            deliverPiecesStr += ' Pcs';
          }
          break;
        } else if (item is String && item.startsWith(awbNum)) {
          final parts = item.split(' - ');
    ...
    for (var awbItem in awbItems) {
      ...
      String uldKeyPrefix =
          '${awbNum}_${awbItem['refULD']}_${awbItem['refNumber']}_';
        ...
        if (isChecked && key.startsWith(uldKeyPrefix)) {
          ...
          if (itemKey == 'NO_BREAK') {
            ...
            if (breakdown['AGI Skid'] is List &&
                (breakdown['AGI Skid'] as List).length > idx) {
              pieces = int.tryParse(breakdown['AGI Skid'][idx].toString()) ?? 0;
            }
          } else {
            dynamic bdVal = breakdown[itemKey];
            if (bdVal == null && itemKey == 'Crate') {
              bdVal = breakdown['Crate(s)'];
            }
            ...
            if (bdVal is List) {
              pieces = bdVal.fold(
                0,
                (a, b) => a + (int.tryParse(b.toString()) ?? 0),
              );
            } else if (bdVal != null) {
    ...
    for (var rejectData in rejectList) {
      rejectedQty +=
          int.tryParse(
            rejectData['pieces']?.toString() ??
                rejectData['qty']?.toString() ??
                '0',
          ) ??
          0;
      ...
      children: [
        ...
        Container(
          ...
          child: Builder(
            builder: (context) {
              Color foundColor =
                  (foundPieces == expectedDeliver && expectedDeliver > 0)
                  ? const Color(0xFF10b981)
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 4),
                          Text(
                            deliverPiecesStr.isEmpty ? '0' : deliverPiecesStr,
                            style: TextStyle(
                              color: textP,
                              fontSize: 24,
                              fontWeight: FontWeight.bold,
                      ...
                      Column(
                        ...
                        children: [
                                  ...
                                  child: Checkbox(
                                    ...
                                    onChanged: (val) {
                                      setState(() {
                                        ...
                                        if (!_autoFoundPieces) {
                                          _manualFoundCtrl.text =
                                              calculatedFoundPieces.toString();
                                        }
                                      });
                                    },
                                  ),
                          ...
                          if (matchingDelivery != null)
                            Text(
                              matchingDelivery['found']?.toString() ?? '0',
                              style: TextStyle(
                                color: foundColor,
                                fontSize: 24,
                                fontWeight: FontWeight.bold,
                                              ...
                                              children: [
                                                ...
                                                if (_localRejections
                                                  ...
                                                  IconButton(
                                                    ...
                                                    tooltip:
                                                        'Delete Local Rejection',
                                                    onPressed: () {
                                                      setState(() {
                                                        _localRejections.remove(
                                                          awbNum,
                                                        );
                                                      });
                                                      Navigator.pop(ctx);
                ...
                Builder(
                  builder: (context) {
                    bool isSavedDelivery =
                        ...
                        matchingDelivery['references'] is List;
                    if (isSavedDelivery) {
                      return Column(
                        children: _buildSavedDeliveryUI(
                          matchingDelivery,
                          awbNum,
                          dark,
                          textP,
                    ...
                    return Column(
                      children: awbItems.map<Widget>((awbItem) {
                        ...
                        for (var c in coordList) {
                          if (c is Map && c['refULD'] == awbItem['refULD']) {
                            if (c['breakdown'] is Map) {
                              breakdown = c['breakdown'] as Map;
                            }
                            break;
                          }
                        }
                        ...
                        bool hasCoord = coordList.any(
                          (c) => c is Map && c['refULD'] == awbItem['refULD'],
                        );
                        ...
                        String dateStr =
                            (awbItem['refDate'] ?? locMatch['refDate'] ?? '')
                                .toString();
                        if (dateStr.length >= 10 && dateStr.contains('-')) {
                        ...
                        String flightStr =
                            '${awbItem['refCarrier'] ?? ''} ${awbItem['refNumber'] ?? ''}'
                                .trim();
                        ...
                        final tableRows = allItemKeys.map<DataRow>((itemKey) {
                          ...
                          if (itemKey.startsWith('AGI Skid_')) {
                            int idx =
                                int.tryParse(itemKey.split('_').last) ?? 0;
                            displayName = 'AGI Skid ${idx + 1}';
                            if (breakdown['AGI Skid'] is List &&
                                (breakdown['AGI Skid'] as List).length > idx) {
                              pieces =
                                  int.tryParse(
                                    breakdown['AGI Skid'][idx].toString(),
                                  ) ??
                                  0;
                            }
                          } else {
                            ...
                            if (bdVal == null && itemKey == 'Box') {
                              bdVal = breakdown['Box(es)'];
                            }
                          ...
                          String locText = (locVal != null && locVal.isNotEmpty)
                              ? locVal.toUpperCase()
                              : 'FLOOR';
                          Color locColor = locText == 'FLOOR' ? textS : textP;

                          String checkKey =
                              '${awbNum}_${awbItem['refULD']}_${awbItem['refNumber']}_$itemKey';
                          bool isChecked =
                              _driverItemCheckState[checkKey] ?? false;

                          _driverItemPayloadData[checkKey] = {
                            'refULD': awbItem['refULD']?.toString() ?? '',
                            'refNumber': awbItem['refNumber']?.toString() ?? '',
                            'refCarrier':
                                awbItem['refCarrier']?.toString() ?? '',
                            'refDate':
                                (awbItem['refDate'] ?? locMatch['refDate'])
                                    ?.toString() ??
                                '',
                          ...
                          String unifiedKey =
                              '${awbItem['refULD']}_${awbItem['refNumber']}_$displayName';
                          bool isAlreadyPickedUp = alreadyPickedUpKeys.contains(
                            unifiedKey,
                          );
                              ...
                              DataCell(
                                isAlreadyPickedUp
                                    ...
                                    : Checkbox(
                                        ...
                                        onChanged: (val) {
                                          setState(() {
                                            _driverItemCheckState[checkKey] =
                                                val == true;
                                          });
                                        },
                                        activeColor: const Color(0xFF6366f1),
                        ...
                        if (!isBreak) {
                          String checkKey =
                              '${awbNum}_${awbItem['refULD']}_${awbItem['refNumber']}_NO_BREAK';
                          bool isChecked =
                              _driverItemCheckState[checkKey] ?? false;
                          String uldNumber =
                              awbItem['refULD']?.toString() ?? 'UNKNOWN ULD';
                          int totalPieces =
                              int.tryParse(
                                awbItem['pieces']?.toString() ?? '0',
                              ) ??
                              0;
                          ...
                          allItemKeys.add(
                            'NO_BREAK',
                          ); // to satisfy the Checkbox allChecked logic below

                          tableRows.clear();

                          String unifiedKey1 =
                              '${awbItem['refULD']}_${awbItem['refNumber']}_NO BREAK AREA';
                          String unifiedKey2 =
                              '${awbItem['refULD']}_${awbItem['refNumber']}_$uldNumber';
                          bool isAlreadyPickedUp =
                              alreadyPickedUpKeys.contains(unifiedKey1) ||
                              alreadyPickedUpKeys.contains(unifiedKey2);

                          if (isUld && awb['data-ULD'] is List && (awb['data-ULD'] as List).isNotEmpty) {
                            List innerAwbs = awb['data-ULD'];
                            for (var inner in innerAwbs) {
                        ...
                        String uldKey =
                            '${awbNum}_${awbItem['refULD']}_${awbItem['refNumber']}';
                        bool isHidden = _hiddenDriverItems.contains(uldKey);
                              ...
                              if (!isHidden && statusText == 'PENDING')
                                ...
                                if (tableRows.isEmpty)
                                  Padding(
                                    padding: const EdgeInsets.all(16),
                                    child: Text(
                                      'No itemized location breakdown available.',
                                      style: TextStyle(
                                        color: textS,
                                        fontStyle: FontStyle.italic,
                                      ),
                                  ...
                                  ClipRRect(
                                    ...
                                    child: LayoutBuilder(
                                      builder: (context, constraints) {
                                        List<String>
                                        selectableKeys = allItemKeys.where((
                                          itemKey,
                                        ) {
                                          ...
                                          if (itemKey == 'NO_BREAK') {
                                            String unifiedKey1 =
                                                '${awbItem['refULD']}_${awbItem['refNumber']}_NO BREAK AREA';
                                            String unifiedKey2 =
                                                '${awbItem['refULD']}_${awbItem['refNumber']}_${awbItem['refULD']}';
                                            return !alreadyPickedUpKeys
                                                    .contains(unifiedKey1) &&
                                                !alreadyPickedUpKeys.contains(
                                                  unifiedKey2,
                                                );
                                          }
                                          String unifiedKey =
                                              '${awbItem['refULD']}_${awbItem['refNumber']}_$displayName';
                                          return !alreadyPickedUpKeys.contains(
                                            unifiedKey,
                                          );
                                        }).toList();
                                        ...
                                        bool allChecked =
                                            ...
                                            selectableKeys.every((itemKey) {
                                              String checkKey =
                                                  '${awbNum}_${awbItem['refULD']}_${awbItem['refNumber']}_$itemKey';
                                              return _driverItemCheckState[checkKey] ==
                                                  true;
                                            });
            ...
            builder: (context) {
              ...
              if (awb['data-deliver'] != null) {
                if (awb['data-deliver'] is List) {
                  for (var d in (awb['data-deliver'] as List)) {
                    if (d is Map &&
                        d['pickup_id'] == _selectedDriver?['id-pickup']) {
                      isDelivered = true;
                      matchingDelivery = d as Map<String, dynamic>;
                      break;
                    }
              ...
              if (isDelivered) {
                return Row(
                  ...
                  children: [
                    ...
                    if (matchingDelivery != null &&
                        matchingDelivery['user'] != null) ...[
                      const SizedBox(width: 8),
                      Text(
                        'by ${matchingDelivery['user']}',
                        style: TextStyle(color: textS),
                      ),
                    ],
                  ],
              ...
              return Row(
                ...
                children: [
                    ...
                    onPressed: _isDelivering
                        ...
                        : () async {
                            ...
                            if (_localRejections.containsKey(awbNum)) {
                              ...
                              locCtrl.text =
                                  rInfo['location']?.toString() == 'OVERSIZE'
                                  ? 'OVERSIZE'
                                  : (rInfo['location']?.toString() ?? '');
                              rejectAll =
                                  ...
                                  return AlertDialog(
                                    ...
                                    content: Column(
                                      ...
                                      children: [
                                        ...
                                        const SizedBox(height: 16),
                                        Text(
                                          'Please provide a reason for rejecting this AWB.',
                                          style: TextStyle(color: textS),
                                        ),
                                        const SizedBox(height: 8),
                                        TextField(
                            ...
                            if (confirm == true &&
                                ...
                                piecesCtrl.text.trim().isNotEmpty) {
                              ...
                              try {
                                ...
                                if (mounted && context.mounted) {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    const SnackBar(
                                      content: Text(
                                        'Error saving rejection locally.',
                                      ),
                                      backgroundColor: Colors.redAccent,
                                    ),
                                  );
                  ...
                  ElevatedButton.icon(
                    onPressed:
                        ((foundPieces + rejectedQty) == expectedDeliver &&
                            expectedDeliver > 0 &&
                            !_isDelivering)
                        ? () async {
                            setState(() => _isDelivering = true);
                                        ...
                                        child: Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                appLanguage.value == 'es'
                                                    ? 'El AWB se entregó correctamente.'
                                                    : 'The AWB was successfully delivered.',
                                                style: TextStyle(
                                                  color: dark
                                                      ? const Color(0xFF94a3b8)
                                                      : const Color(0xFF64748b),
  ...
  Future<void> _showDriverCoordinatorDialog(
    Map<String, dynamic> awb,
    Map<String, dynamic> awbItem,
  ) async {
    ...
    int expectedPieces =
        int.tryParse(awbItem['pieces']?.toString() ?? '0') ?? 0;
    int enteredPieces = 0;
        ...
        return StatefulBuilder(
          builder: (context, setDialogState) {
            void updateCount() {
              ...
              if (sum != enteredPieces) {
                setDialogState(() => enteredPieces = sum);
              }
            }
            ...
            Widget buildField(String label) {
              return Padding(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    labelText: label == 'AGI Skid'
                        ? 'AGI Skid (space separated)'
                        : label,
                    labelStyle: TextStyle(
                      color: textS,
                      fontSize: label == 'AGI Skid' ? 13 : 15,
                    ),
                    border: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(8),
                    ),
                      ...
                      Column(
                        children: [
                          ...
                          Text(
                            '$enteredPieces',
                            style: TextStyle(
                              color: enteredPieces == expectedPieces
                                  ? const Color(0xFF10b981)
                  ...
                  onPressed: isLoading
                      ...
                      : () async {
                          ...
                          try {
                            ...
                            if (existing != null &&
                                existing['data-coordinator'] != null) {
                              if (existing['data-coordinator'] is List) {
                                existingDcList = List.from(
                          ...
                          if (_selectedDriver != null) {
                            final previouslySelectedAwbNumber =
                                awb['AWB-number'];
                            await _loadDriverDetails(_selectedDriver!);

                            if (mounted) {
                              try {
                                final matchingAwb = _driverAwbs.firstWhere(
                                  (a) =>
                                      a['AWB-number'] ==
                                      previouslySelectedAwbNumber,
                                );
                                setState(
                                  () => _selectedAwbDetails = matchingAwb,
                                );
                              } catch (_) {}
                            }
                          }
