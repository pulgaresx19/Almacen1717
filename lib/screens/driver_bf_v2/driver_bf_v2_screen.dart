...
import 'driver_bf_v2_panel.dart';
import 'driver_bf_v2_direct_delivery_dialog.dart';

class DriverBfV2Screen extends StatefulWidget {
  final bool isActive;
  const DriverBfV2Screen({super.key, this.isActive = false});

  @override
  State<DriverBfV2Screen> createState() => _DriverBfV2ScreenState();
}

class _DriverBfV2ScreenState extends State<DriverBfV2Screen> {
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        Text(
                          appLanguage.value == 'es' ? 'Conductor (BF)' : 'Driver (BF)',
                          style: TextStyle(
                ...
                Expanded(
                  child: Container(
                    ...
                    child: DriverBfV2Panel(searchQuery: _searchController.text),
                  ),
                ),
              ],
            ),
            Positioned(
              ...
              child: FloatingActionButton.extended(
                onPressed: () {
                  showDialog(
                    context: context,
                    builder: (context) => DriverBfV2DirectDeliveryDialog(dark: dark),
                  );
                },
                backgroundColor: const Color(0xFF6366f1),
                icon: const Icon(Icons.outbox_rounded, color: Colors.white),
                label: Text(
                  appLanguage.value == 'es' ? 'Entrega Directa' : 'Direct Delivery',
