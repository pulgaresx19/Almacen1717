...
class _CoordinatorModuleState extends State<CoordinatorModule> {
  ...
  void _processUldsData(bool isLeft, List<Map<String, dynamic>> data) {
    ...
    for (var i = 0; i < mapped.length; i++) {
      var newUld = mapped[i];
      if (newUld['id'] != null &&
          _savedUldCheckboxState.containsKey(newUld['id'])) {
      ...
      children: [
        Container(
          ...
          child: Column(
            ...
            children: [
              Row(
                mainAxisAlignment: (!isLoading && flights.isNotEmpty)
                                          ...
                                          Builder(
                                            builder: (ctx) {
                                              ...
                                              if (uld['data-checked'] != null &&
                                                  uld['data-checked']['discrepancies'] !=
                                                      null) {
                                                final discs =
                                                    uld['data-checked']['discrepancies']
                                                        as List;
                                                ...
                                                for (var awbItem in listAwb) {
                                                  ...
                                                  bool hasDisc = false;
                                                  List<dynamic> dcList = [];
                                                  if (awbItem['data-coordinator']
                                                      is List) {
                                                    dcList =
                                                        awbItem['data-coordinator']
                                                            as List;
                                                  } else if (awbItem['data-coordinator']
                                                      is Map) {
                                                    dcList = [
                                                      awbItem['data-coordinator'],
                                                    ];
                                                  ...
                                                  for (var dc in dcList) {
                                                    if (dc is Map &&
                                                      ...
                                                      if (dc['discrepancy'] !=
                                                              null &&
                                                          dc['discrepancy']['confirmed'] ==
                                                              true) {
                                                        hasDisc = true;
                                                        bool isNotFound =
                                                            dc['discrepancy']['notFound'] ==
                                                            true;
                                                        if (isNotFound) {
                                                          checked = true;
                                                        }
                                                        int rExp =
                                                            dc['discrepancy']['expected']
                                                                as int? ??
                                                            0;
                                                        int rRev =
                                                            dc['discrepancy']['received']
                                                                as int? ??
                                                            0;
                                                        int diff = (rExp - rRev)
                                                            .abs();
                                                  ...
                                                  if (awbItem['isNew'] ==
                                                    ...
                                                    if (!hasDisc) {
                                                      ...
                                                      if (idx != -1) {
                                                        discrepantAwbsList[idx]['label'] =
                                                            '${discrepantAwbsList[idx]['label']} (NEW)';
                                                      }
                                                    }
                                                  }
                                              ...
                                              final isCheckedStatus =
                                                  (uld['data-checked'] as Map?)
                                                      ?.isNotEmpty ==
                                                  true;
                                              final isReceivedStatus =
                                                        ...
                                                        ? () async {
                                                            try {
                                                              ...
                                                              final List<
                                                                ...
                                                                >
                                                              >
                                                              finalDiscList = discrepantAwbsList
                                                                  .map(
                                                                    (e) => {
                                                                      'uld': uld['ULD-number']
                                                                          ?.toString()
                                                  ...
                                                  Column(
                                                    children: List.generate(
                                                      ...
                                                      (awbIdx) {
                                                        ...
                                                        List<dynamic> dcList =
                                                            [];
                                                        if (awb['data-coordinator']
                                                            is List) {
                                                          dcList =
                                                              awb['data-coordinator']
                                                                  as List;
                        ...
                        children: [
                          Expanded(
                            child: Wrap(
                              ...
                              children: [
                                ...
                                Builder(
                                  builder: (ctx) {
                                    final awbsWithLocs = _getAwbsWithLocations(
                                      isLeft ? _uldsLeft : _uldsRight,
                                    );
                          ...
                          Builder(
                            builder: (context) {
                              ...
                              List<Map<String, dynamic>>
                              allFlightDiscrepancies = [];

                              for (var u in currentUlds) {
                                if (u['data-checked'] != null &&
                                    u['data-checked']['discrepancies'] !=
                                        null) {
                                  final discs =
                                      u['data-checked']['discrepancies']
                                          as List;
                                  ...
                                  for (var awbItem in u['awbList']) {
                                    ...
                                    if (awbItem['data-coordinator'] is List) {
                                      dcList =
                                          awbItem['data-coordinator'] as List;
                                    } else if (awbItem['data-coordinator']
                                        is Map) {
                                      dcList = [awbItem['data-coordinator']];
                                    }

                                    final uldNum = u['ULD-number']
                                        ?.toString()
                                        .toUpperCase();
                                    final uCarrier = u['refCarrier']
                                        ?.toString();
                                    ...
                                    for (var dc in dcList) {
                                      if (dc is Map &&
                                          dc['refULD']
                                                  ...
                                                  .toUpperCase() ==
                                              uldNum &&
                                          dc['refCarrier']?.toString() ==
                                              uCarrier &&
                                          dc['refNumber']?.toString() ==
                                              uFlight) {
                                        if (dc['discrepancy'] != null &&
                                            dc['discrepancy']['confirmed'] ==
                                                true) {
                                          hasDisc = true;
                                          bool isNotFound =
                                          ...
                                          String tStr = rExp > rRev
                                              ? 'SHORT'
                                              : 'OVER';
                                          allFlightDiscrepancies.add({
                                            'uld': uldNum ?? 'Unknown ULD',
                                            'awb':
                                                awbItem['number']?.toString() ??
                                                'N/A',
                                            'label': isNotFound
                                                ? 'NOT FOUND'
                                                : '$diff PCs $tStr',
                                    ...
                                    if (awbItem['isNew'] == true) {
                                      if (!hasDisc) {
                                        ...
                                        int idx = allFlightDiscrepancies
                                            .indexWhere(
                                              (e) =>
                                                  e['awb'] ==
                                                  awbItem['number']?.toString(),
                                        ...
                                        if (idx != -1) {
                                          allFlightDiscrepancies[idx]['label'] =
                                              '${allFlightDiscrepancies[idx]['label']} (NEW)';
                                        }
                                      }
                                    }
                              ...
                              bool hasSentReport =
                                  currentFlightIdx != -1 &&
                                  flightList[currentFlightIdx]['report-final'] !=
                                      null;
                              ...
                              Widget discrepanciesButton = ElevatedButton.icon(
                                              ...
                                              if (rawReport is List) {
                                                ...
                                                reportData =
                                                    (rawReport['items']
                                                        as List?) ??
                                                    [];
                                                sentBy = rawReport['sentBy']
                                                    ?.toString();
                                                sentAtStr = rawReport['sentAt']
                                                    ?.toString();
                                              }
                                              ...
                                              if (sentAtStr != null) {
                                                try {
                                                  ...
                                                  String suff = pm
                                                      ...
                                                      : 'am';
                                                  formattedDate =
                                                      '${dtSent.day}/${dtSent.month} $h12:$mm $suff';
                                                } catch (_) {}
                                              }
                                                              ...
                                                              Expanded(
                                                                child: Column(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Text(
                                                                      '${reportData.length} total items in report',
                                                                      style: const TextStyle(
                                                                        color: Color(
                                                                          0xFF94a3b8,
                                                                        ),
                                                                    ...
                                                                    if (sentBy !=
                                                                      ...
                                                                      Text(
                                                                        'Sent by: $sentBy${formattedDate.isNotEmpty ? ' at $formattedDate' : ''}',
                                                                        style: const TextStyle(
                                                                          color: Color(
                                                                            0xFF6366f1,
                                                                          ),
                                                                    ...
                                                                    children: [
                                                                      Row(
                                                                        ...
                                                                        children: [
                                                                          Row(
                                                                            children: [
                                                                              if (verificationMap[d['awb']?.toString()] ==
                                                                                  true)
                                                                                const Padding(
                                                                                  ...
                                                                                  builder:
                                                                                      (
                                                                                        ...
                                                                                        final awbStr =
                                                                                            d['awb']?.toString() ??
                                                                                            '';
                                                                                        bool hasNote = localDiscrepancyReports.any(
                                                                                          (
                                                                                            r,
                                                                                          ) =>
                                                                                              r['awb'] ==
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          if (verificationMap[d['awb']?.toString()] !=
                                                                                    ...
                                                                                    (
                                                                                      ...
                                                                                      return IconButton(
                                                                                        ...
                                                                                        onPressed: () {
                                                                                          setStateDialog(
                                                                                            () {
                                                                                              showCommentMap[awbStr] =
                                                                                                  !(showCommentMap[awbStr] ??
                                                                                                      false);
                                                                                              if (showCommentMap[awbStr] ==
                                                                                                      true &&
                                                                                                  !commentControllersMap.containsKey(
                                                                                                    awbStr,
                                                                                                  )) {
                                                                                                commentControllersMap[awbStr] = TextEditingController();
                                                                                                if (hasNote) {
                                                                                                  final noteObj = localDiscrepancyReports.firstWhere(
                                                                                                    (
                                                                                                      r,
                                                                                                    ) =>
                                                                                                        r['awb'] ==
                                                                                                  ...
                                                                                                  commentControllersMap[awbStr]!.text =
                                                                                                      noteObj['note'] ??
                                                                                                      '';
                                                                                                }
                                                                                              }
                                                                            ...
                                                                            Container(
                                                                              ...
                                                                              child: Text(
                                                                                verificationMap[d['awb']?.toString()] ==
                                                                                        true
                                                                                    ? 'MATCH (GOOD)'
                                                                                    : verificationDiffMap[d['awb']?.toString()]! >
                                                                                          0
                                                                                    ? '${verificationDiffMap[d['awb']?.toString()]} EXTRA'
                                                                                    : '${verificationDiffMap[d['awb']?.toString()]!.abs()} MISSING',
                                                                                style: TextStyle(
                                                                                  color:
                                                                                      verificationMap[d['awb']?.toString()] ==
                                                                                          true
                                                                                  ...
                                                                                  setStateDialog(
                                                                                    () {
                                                                                      final awbStr =
                                                                                          ...
                                                                                          '';
                                                                                      final noteTxt =
                                                                                          commentControllersMap[awbStr]?.text.trim() ??
                                                                                          '';

                                                                                      localDiscrepancyReports.removeWhere(
                                                                                        (
                                                                                          r,
                                                                                        ) =>
                                                                                            r['awb'] ==
                                                            ...
                                                            builder: (ctx) {
                                                              bool isVerified =
                                                                  verificationMap
                                                                      .isNotEmpty;
                                                              bool
                                                              hasBadItemsWithoutNote =
                                                                  false;
                                                              if (isVerified) {
                                                                for (var d
                                                                    in localDiscrepancies) {
                                                                  String
                                                                  awbStr =
                                                                      d['awb']
                                                                          ?.toString() ??
                                                                      '';
                                                                  if (verificationMap[awbStr] ==
                                                                      false) {
                                                                    if (!localDiscrepancyReports.any(
                                                                      (r) =>
                                                                          r['awb'] ==
                                                                          awbStr,
                                                                    )) {
                                                                ...
                                                                child: ElevatedButton.icon(
                                                                  onPressed:
                                                                      ...
                                                                      : () async {
                                                                          if (isReadyToSave) {
                                                                            ...
                                                                            try {
                                                                              ...
                                                                              for (var d in localDiscrepancies) {
                                                                                ...
                                                                                bool
                                                                                isValid =
                                                                                    verificationMap[awbStr] ==
                                                                                    true;
                                                                                int
                                                                                diff =
                                                                                    verificationDiffMap[awbStr] ??
                                                                                    0;
                                                                                String?
                                                                                note;
                                                                                if (!isValid) {
                                                                                  try {
                                                                                    note = localDiscrepancyReports
                                                                                        .firstWhere(
                                                                                          (
                                                                                            r,
                                                                                          ) =>
                                                                          ...
                                                                          try {
                                                                            final uniqueAwbs = localDiscrepancies
                                                                                .map(
                                                                                  (
                                                                                    e,
                                                                                  ) => e['awb']?.toString(),
                                                                            ...
                                                                            if (uniqueAwbs.isNotEmpty) {
                                                                              final awbData = await Supabase.instance.client
                                                                                  ...
                                                                                  .select(
                                                                                    'AWB-number, total, data-coordinator',
                                                                                  )
                                                                                  .inFilter(
                                                                                    'AWB-number',
                                                                                    uniqueAwbs,
                                                                              ...
                                                                              for (var awbRow in awbData) {
                                                                                ...
                                                                                verificationMap[awbNum] =
                                                                                    (total ==
                                                                                    sumBreakdown);
                                                                                verificationDiffMap[awbNum] =
                                                                                    sumBreakdown -
                                                                                    total;
                                                                              }
                                                                            }
                                                                          ...
                                                                          if (context
                                                                            ...
                                                                            setStateDialog(() {
                                                                              isVerifying = false;
                                                                              localDiscrepancies.sort(
                                                                                (
                                                                                  a,
                                                                                  b,
                                                                                ) {
                                                                                  bool aValid =
                                                                                      verificationMap[a['awb']?.toString()] ==
                                                                                      true;
                                                                                  bool bValid =
                                                                                      verificationMap[b['awb']?.toString()] ==
                                                                                      true;
                                                                                  if (aValid &&
                                                                                      !bValid) {
                                                                                    return -1;
                                                                  ...
                                                                  label: Text(
                                                                    !allUldsChecked
                                                                        ? (appLanguage.value ==
                                                                                  'es'
                                                                              ? 'Verifica todos los ULDs primero'
                                                                              : 'Check all ULDs first')
                                                                        : (isVerifying
                                                                              ? 'Verifying...'
                                                                              : (isReadyToSave
                                                                                    ? 'Save Report'
                                ...
                                label: Text(
                                  totalFlightDiscrepancies > 0
                                      ? (hasSentReport
                                            ? 'Sent Report View'
                                            : '$totalFlightDiscrepancies Total Discrepanc${totalFlightDiscrepancies == 1 ? 'y' : 'ies'}')
                                      : 'No Discrepancies',
                                  style: const TextStyle(
                                    fontWeight: FontWeight.bold,
                                  ),
                                ...
                                style: ElevatedButton.styleFrom(
                                  backgroundColor: totalFlightDiscrepancies > 0
                                      ? (hasSentReport
                                            ? const Color(
                                                0xFF10b981,
                                              ).withAlpha(100)
                                  ...
                                  foregroundColor: totalFlightDiscrepancies > 0
                                      ? Colors.white
                            ...
                            Flexible(
                              child: ListView.separated(
                                ...
                                itemBuilder: (c, i) {
                                  ...
                                  final uldNum = activeUld['ULD-number']
                                      ?.toString()
                                      .toUpperCase();
                                  final uldCarrier = activeUld['refCarrier']
                                      ?.toString();
                                  final uldFlight = activeUld['refNumber']
                                      ?.toString();
                                      ...
                                      if (bd is Map && bd.isNotEmpty) {
                                        ...
                                        if (dc['discrepancy'] != null &&
                                          ...
                                          String term = exp > rec
                                              ? 'SHORT'
                                              : 'OVER';
                                          discrepancyBadge = isNotFound
                                              ? 'NOT FOUND'
                                              : '$diff PCs $term';
                                        }
                                        if (isChecked) {
                                          awbCheckedUser = dc['user']
                                              ?.toString();
                                          awbCheckedTime = dc['time']
                                              ?.toString();
                                        }
                                      }
                                    }
  ...
  List<Map<String, dynamic>> _getAwbsWithLocations(
    List<Map<String, dynamic>> ulds,
  ) {
    List<Map<String, dynamic>> matchingAwbs = [];
    for (var u in ulds) {
      if (u['inf-location-requerid'] != null &&
          u['inf-location-requerid'] is List) {
        ...
        for (var awbItem in u['awbList']) {
          ...
          for (var dc in dcList) {
            if (dc is Map &&
                dc['refULD']?.toString().toUpperCase() == uldNum &&
                  ...
                  .then((res) {
                    if (res != null) {
                      ...
                      if (res['data-coordinator'] is List) {
                        ...
                        final uldNum = uldOverride?['ULD-number']
                            ?.toString()
                            .toUpperCase();
                        final match = listDc
                            .where(
                          ...
                          : () async {
                              ...
                              try {
                                ...
                                if (existing != null) {
                                  ...
                                  } else if (existing['data-coordinator']
                                      is Map) {
                                    existingDcList = [
                                      existing['data-coordinator'],
                                    ];
                                ...
                                final uldNum =
                                    uldOverride?['ULD-number']
                                        ?.toString()
                                        .toUpperCase() ??
                                    '';
                                final uldCar =
                                    uldOverride?['refCarrier']?.toString() ??
                                    '';
                                final uldFlt =
                                    uldOverride?['refNumber']?.toString() ?? '';
                                final uldDate =
                                    uldOverride?['refDate']?.toString() ?? '';

                                // Find existing map for this ULD if any
                                int matchIndex = existingDcList.indexWhere(
                                  (d) =>
                                      d is Map &&
                                      d['refULD']?.toString().toUpperCase() ==
                                          uldNum &&
                                      d['refNumber']?.toString() == uldFlt,
                                );
                                if (matchIndex != -1) {
                                  coordData = Map<String, dynamic>.from(
                                    existingDcList[matchIndex],
                                  );
                                }
                                ...
                                breakdown.forEach((key, list) {
                                  if (key == 'AGI Skid') {
                                    ...
                                    breakdownToSave[key] = list.isNotEmpty
                                        ? list.first
                                        : 0;
                                  }
                                });
