                                     ...
                                     Column(
                                        ...
                                        children: [
                                           Container(
                                              ...
                                              child: Center(child: Text(awb['AWB-number']?.toString() ?? 'N/A', style: const TextStyle(fontSize: 22, fontWeight: FontWeight.bold, letterSpacing: 2))),
                                           ),
                                           const SizedBox(height: 8),
                                           Container(
                                              height: 45,
                                         ...
                                         Expanded(
                                            child: Column(
                                               ...
                                               children: [
                                                  ...
                                                  Text(awb['total']?.toString() ?? '0', style: const TextStyle(fontSize: 20, fontWeight: FontWeight.w900)),
                                               ]
                                            ),
                                         ),
