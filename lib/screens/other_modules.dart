      ...
      children: [
        ...
        children: [
          Row(
            ...
            children: [
              Text(isLeft ? (appLanguage.value == 'es' ? 'Panel Izquierdo' : 'Left Panel') : (appLanguage.value == 'es' ? 'Panel Derecho' : 'Right Panel'), style: TextStyle(color: textP, fontSize: 24, fontWeight: FontWeight.bold)),
              ElevatedButton.icon(
          ...
          if (isLoading)
            ...
            Wrap(
              ...
              children: flights.map((f) {
                ...
                final isOppositeSel = isLeft ? (_selectedFlightIdRight == chipId) : (_selectedFlightIdLeft == chipId);
                                          ...
                                          if (idx != -1) {
                                            if (v == true) {
                                              if (currentFlightList[idx]['local-first-truck'] == null) {
                                                currentFlightList[idx]['local-first-truck'] = DateFormat('HH:mm:ss').format(DateTime.now());
                                              }
                                              currentFlightList[idx]['local-truck-arrived'] ??= <String, dynamic>{};
                                              String uldKey = uld['ULD-number']?.toString() ?? 'Unknown';
                                              currentFlightList[idx]['local-truck-arrived'][uldKey] = DateFormat('HH:mm:ss').format(DateTime.now());
                                            } else {
                                  ...
                                  if (selectedId != null && dt != null) {
                                    ...
                                    if (parts.length >= 2) {
                                      ...
                                      try {
                                        ...
                                        String firstTruckTime = DateFormat('HH:mm:ss').format(DateTime.now());
